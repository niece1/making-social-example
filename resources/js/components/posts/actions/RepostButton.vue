<template>
	<a href="#" class="flex items-center text-base" @click="$emit('click', $event)">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24" class="fill-current text-gray-600 w-5 mr-2" :class="{ 'text-green-600': reposted }">
    ...
    <span class="text-gray-600" :class="{ 'text-green-600': reposted }">{{ post.reposts_count }}</span>
  </a>
</template>
